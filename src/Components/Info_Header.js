...
export const ViewHeader = ({ track, wiki }) => <div className="my-5 ant-row _1Hykx rowgap">
  ...
  <div className="ant-col _1iPHb ant-col-xs-24 ant-col-md-14 ant-col-lg-17">
    ...
    <div className="_1LTl0">
      {/* <button type="button" className="ant-btn ant-btn-icon-only hgoDm undefined _2y01H">
        <i className="_3AXtk"></i>
      </button> */}
